...
In order to install the plugin, simply run the following command from your Elasticsearch home directory: 
    ...
    bin/plugin -install analysis-standard-ext -url http://dl.bintray.com/bbguitar77/maven/org/elasticsearch/elasticsearch-analysis-standardext/VERSION/elasticsearch-analysis-standardext-VERSION.zip
