...
/**
 * <b>Derivation</b> of Lucene's {@link StandardTokenizer} that leverages a
 * different {@link StandardTokenizerInterface}
 *
 * <p>
 ...
 * StandardTokenizer:
 * <ul>
 * <li>As of 3.4, Hiragana and Han characters are no longer wrongly split from
 * their combining characters. If you use a previous version number, you get the
 * exact broken behavior for backwards compatibility.
...
public final class ExtensibleStandardTokenizer extends Tokenizer {
  ...
  private final void init(Version matchVersion) {
    init(matchVersion, Collections.<Character, Character> emptyMap());
  }
