...
/**
 * <b>Derivation</b> of Lucene's {@link StandardTokenizerImpl} that supports
 * custom character mappings to override default word boundary rules
 *
 * <p>
 ...
 * </ul>
 */
public final class ExtensibleStandardTokenizerImpl implements StandardTokenizerInterface {
   ...
   */
  private static final String   ZZ_CMAP_PACKED               = "\42\0\1\15\4\0\1\14\4\0\1\7\1\0\1\10\1\0\12\4" + "\1\6\1\7\5\0\32\1\4\0\1\11\1\0\32\1\57\0\1\1"
  ...
  private final char[]          ZZ_CMAP_EXT;
  ...
  private static final String   ZZ_ACTION_PACKED_0           = "\1\0\1\1\1\2\1\3\1\4\1\5\1\1\1\6" + "\1\7\1\2\1\1\1\10\1\2\1\0\1\2\1\0"
  ...
  private static final String ZZ_ROWMAP_PACKED_0 = "\0\0\0\22\0\44\0\66\0\110\0\132\0\154\0\176" + "\0\220\0\242\0\264\0\306\0\330\0\352\0\374\0\u010e"
  ...
  private static final String ZZ_TRANS_PACKED_0 = "\1\2\1\3\1\4\1\2\1\5\1\6\3\2\1\7" + "\1\10\1\11\2\2\1\12\1\13\2\14\23\0\3\3"
   ...
   */
  public ExtensibleStandardTokenizerImpl(java.io.Reader in) {
    this(in, Collections.<Character, Character> emptyMap());
  }
   ...
   *          the java.io.Reader to read input from.
   * @param cmap
   *          Custom character mapping translations
   */
  public ExtensibleStandardTokenizerImpl(java.io.Reader in, Map<Character, Character> cmap) {
    this.zzReader = in;
    ZZ_CMAP_EXT = zzFillCMapExt(cmap);
  }

  /**
   * Fills the character translation table accounting for any character mapping
   * overrides
   *
   * @param cmap
   *          custom override character translation mappings
   * @return the unpacked character translation table
   */
  private static char[] zzFillCMapExt(Map<Character, Character> cmap) {
    char[] map = Arrays.copyOf(ZZ_CMAP, ZZ_CMAP.length);
    for (Entry<Character, Character> entry : cmap.entrySet()) {
      int pos = (int) entry.getKey();
      map[pos] = entry.getValue();
    }
    return map;
  }
