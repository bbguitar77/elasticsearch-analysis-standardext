...
public final class ExtensibleStandardTokenizerImpl implements StandardTokenizerInterface {
   ...
   *
   * @param   in    the java.io.Reader to read input from.
   * @param   cmap  Custom character mapping translations
   */
  ...
  /**
   * Fills the character translation table accounting for any character mapping overrides
   *
   * @param cmap  custom override character translation mappings
